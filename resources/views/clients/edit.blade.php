...
@section('location-nav')
    <ol class="breadcrumb panel">
        ...
        <li class="active"><strong>Modifier un client</strong></li>
    </ol>
@endsection
@section('x_title')
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="form-group  @if($errors->get('name')) has-error @endif ">
                    ...
                    <input id="name" type="text" class="form-control" value="{{old('name',$client->name)}}" name="name"
                           required=""/>
                ...
                <div class="form-group  @if($errors->get('cin')) has-error @endif ">
                    ...
                    <input id="cin" type="text" class="form-control" value="{{old('cin',$client->cin)}}" name="cin"
                           required=""/>
                ...
                <div class="form-group  @if($errors->get('tel')) has-error @endif ">
                    ...
                    <input id="tel" type="text" class="form-control" value="{{old('tel',$client->tel)}}" name="tel"
                           required=""/>
                ...
                <div class="form-group  @if($errors->get('attached_file')) has-error @endif ">
                    <label for="attached_file">Changer la Pièce jointe :</label>
                    <input id="attached_file" type="file" class="file" value="" name="attached_file"/>
